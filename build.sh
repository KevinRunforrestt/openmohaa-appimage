...
<html>
<head>
    <title>/tmp/files - build.sh</title>
...
<div id="container">
    ...
    <div class="show-content">
        <h2 class="file-title">build.sh</h2>

                    
            <p><a class="download" href="https://tmpfiles.org/dl/1786800727.c7f8437c418c9b4f/wHwCSwQJmZ6a/build.sh">Download (11.66 KB)</a></p>
        
        <p class="file-meta">File expires in 54 minutes</p>
    </div>
